package org.malu.modules.utils;
...
import org.malu.modules.orm.Page;
import org.malu.modules.orm.PropertyFilter;
import org.malu.modules.orm.PropertyFilter.MatchType;
import org.malu.modules.utils.json.JSONUtil;
import org.malu.modules.utils.string.StringUtil;
import org.malu.tuan.entity.IdEntity;
...
public class PropertyFilterUtils {
	 ...
	 * @throws Exception
	 */
	public static void handleFilter(Page<?> page, Class<?> clazz, List<PropertyFilter> filters, HttpServletRequest request) throws Exception {

		// 读取JSON数据
		JSONObject params = JSONUtil.readJson(request);
