package org.malu.modules.utils.string;
...
public class StringUtil {
	 ...
	 * 5个ab连接的字符串, batchCreateString("ab", 5)，结果：
ababababab
	 * @param string	字符串
	 * @param times		生成字符串的次数
	 * @return
	 */
	public static String batchCreateString(String string, int
times) {
	 ...
	 * @return 以逗号分隔的值
	 */
	public static String arrayToString(String[] srcArray, String
addToPre, String addToBehind) {
		StringBuffer result = new StringBuffer();
		for (int i = 0; i < srcArray.length; i++) {
